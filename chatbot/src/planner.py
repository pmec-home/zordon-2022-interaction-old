...
class ChatBot():
	def __init__(self):
		...
		rospy.wait_for_service('/zordon/stt_whisper')
		rospy.wait_for_service('/zordon/stt_nemo')
		...
		self.stt_whisper = rospy.ServiceProxy('/zordon/stt_whisper', Trigger)
		self.stt_nemo = rospy.ServiceProxy('/zordon/stt_nemo', Trigger)
